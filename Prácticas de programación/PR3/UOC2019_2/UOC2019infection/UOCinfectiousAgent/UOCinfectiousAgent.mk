...
WorkspacePath          :=/media/sf_VM/PR1/UOC2019infection
ProjectPath            :=/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "/media/sf_VM/PR1/UOC2019infection/.build-debug"
	@echo rebuilt > "/media/sf_VM/PR1/UOC2019infection/.build-debug/UOCinfectiousAgent"
...
$(IntermediateDirectory)/src_country.c$(ObjectSuffix): src/country.c $(IntermediateDirectory)/src_country.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/country.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_country.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_infection.c$(ObjectSuffix): src/infection.c $(IntermediateDirectory)/src_infection.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/infection.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_infection.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_city.c$(ObjectSuffix): src/city.c $(IntermediateDirectory)/src_city.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/city.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_city.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_infectiousAgent.c$(ObjectSuffix): src/infectiousAgent.c $(IntermediateDirectory)/src_infectiousAgent.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/infectiousAgent.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_infectiousAgent.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_research.c$(ObjectSuffix): src/research.c $(IntermediateDirectory)/src_research.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/research.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_research.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_reservoir.c$(ObjectSuffix): src/reservoir.c $(IntermediateDirectory)/src_reservoir.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_VM/PR1/UOC2019infection/UOCinfectiousAgent/src/reservoir.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_reservoir.c$(ObjectSuffix) $(IncludePath)
